...
| Date | Change |
|------|--------|
| 2026-08-22 | Ripristinato il velo di boot (copertura `html::before` dal primo paint, niente flash di pagina). Linee SVG della mappa di nuovo visibili: foto sotto il tratto, etichette `01.IMG` / servizio sopra. |
