...
| 2026-08-21 | **Bilancio GPU mobile.** Su compact/touch spegne prospettiva, derive decorative e lo svelamento clip-path; i visual passano da `next/image` (variante ridimensionata invece dei PNG da ~2 MB). Il flash/lag su telefono veniva dal compositor, non da Vercel. |
