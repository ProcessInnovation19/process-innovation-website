...
| 2026-08-22 | **Bilancio GPU senza rimuovere la scena.** `PointerDepth` scrive le variabili solo sui layer che le consumano, accorcia l'inseguimento e mette in pausa le derive autonome mentre puntatore o scroll muovono la profondità; sotto una finestra anche input e fondo vengono congelati, evitando di ricampionare animazioni dietro al blur. I layer usano containment; pannelli, reti, interferenza e parallasse restano presenti. |
